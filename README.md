...
<div align="center">
<img src="assets/interview-prep.png" alt="面试准备示例：分轮次准备、逐 bullet 深挖、表达状态、自我介绍、核心项目讲解和面后复盘题库" width="78%" />
</div>
...
信息不完整时不会直接乱编：能自动搜索/推断的先补齐，补不齐的会标成"低置信/待确认"并降级产出。中间会有关键确认点（简历定稿前、逐 bullet 深挖表、表达状态/自我介绍、分轮次话术前），你过一眼对不对再继续。简历已经投出去改不了，就直接说"按我简历准备面试"，跳过第 2 步。
